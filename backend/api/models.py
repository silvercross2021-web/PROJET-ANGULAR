...
class Projet(models.Model):
    ...
    image_upload = models.ImageField(upload_to='projets/images/', blank=True, null=True)
    video_presentation = models.FileField(upload_to='projets/videos/', blank=True, null=True)
    fichier_joint = models.FileField(upload_to='projets/fichiers/', blank=True, null=True)
